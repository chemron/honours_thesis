...
\begin{figure}[t]%
  ...
  quality data. \subref{fig:aia_no_degredation} The percentiles of the SDO
...
\includegraphics[width=\linewidth]{STEREO_no_degradation.png}%
  ...
  quality data. \subref{fig:stereo_no_degredation} The percentiles of the
...
} \caption{\subref{fig:6.11.11_STE} a STEREO-A EUV image taken on 31st of October
  2011. \subref{fig:6.11.11_MAG} the corresponding magnetogram generated by the
  UV-GAN}
...
This left 2899 seismic map/STEREO magnetogram imapge pairs, which were used to
retrain the Seismic-GAN. Unfortunately this resulted in mode-collapse, where
...
(see Section \ref{sec:learning}). Figure \ref{fig:batch} shows an example
magnetogram generated using this Seismic-GAN. This time the GAN was able to
predict some of the active regions, albeit with mixed accuracy, and was unable
to predict the shape and size of active. We analyse the performance of this cGAN
in Chapter \ref{chap:results_and_analysis}.
