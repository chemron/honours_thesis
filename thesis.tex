...
\section{UV-GAN}
We find that the UV-GAN is able to successfully qualitatively reproduce the
position and shape of active regions upon inspection of the validation data (for
example, see Figure \ref{fig:aia_hmi_mag}). It is unable to determine the
absolute magnetic field strength however and often struggles to reproduce the
polarity of individual sunspots, but seems to guess the polarity according to
Hale's law (see Section \ref{sec:dynamo}).
%TODO: reword
