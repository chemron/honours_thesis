...
The final predictions could have been im

an alternative to this could have been to avoid the use of the EUV data
alltogether, and instead train the GAN on the nearside images half of a
rotation later
this may have been more difficult to train as many of the active regions
will have shifted, however this would consist of a much simpler pipeline.
another idea could be to give the GAN information about the magnetic
...
this would mean the gan would be learning only how the magnetic field
