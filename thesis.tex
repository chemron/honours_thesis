...
\begin{figure}[t]%
  ...
  \caption[]{Left: SDO \SI{304}{\angstrom} EUV image taken on 12th November
  2014. Middle: SDO magnetogram taken at the same time as the EUV image. Right:
  the magnetogram predicted by UV-GAN with the EUV image as input.}
...
\begin{figure}[t]%
  ...
  \subref{fig:6.11.11_def_STE} is a STEREO-A EUV image taken on 11th of November 2011,
...
\begin{figure}[t]%
  ...
  later on the 6th of November 2016, while \subref{fig:16.11.06_kernal} shows
...
\begin{figure}[t]%
  ...
  \caption[]{\subref{fig:6.11.11_STE} is a STEREO-A EUV image taken on 11th of
  November 2011,
...
\begin{figure}[t]%
  ...
  \caption[]{\subref{fig:uv_mag_2011_11_15} is a synthetic STEREO magnetogram
...
To provide greater warning for such events we 


train a cGAN to generate 
synthetic farside magnetograms from farside seismic maps. 



Our method consisted
of two parts. First, we trained a cGAN (UV-GAN) to generate synthetic magnetograms using only
EUV images based on data from the Solar Dynamics Observatory. This 
Here we
report the ability to generate synthetic farside magnetograms using only seismic
maps\textemdash farside images of the Sun created by helioseismic holography. 


\begin{itemize}
  \item this was done in two parts
  \item we first trained a deep learning model to generate synthetic magnetograms using only
  EUV images based on data from the Solar Dynamics Observatory. 
\end{itemize}
...
% regions before they rotate to the nearside. Futhermore, a better understanding
