...
imaging process, and the resulting image can then be used for analysis. The
...
From the 4313 AIA images used between 2010 and 2020, the pixel values for the
AIA data range from \(\SI[]{-166}[]{DN}\) to \(\SI[]{16383}[]{DN}\). The get a
