...
discrimnator architecture is used for both the UV-GAN and the Seismic GAN. We
outline this architecture below.
...
Chapter \ref{chap:discussion}. Our model consists of a U-NET style generator
\citep{ronneberger_u-net_2015}, and a fully convolutional discriminator. Figure
\ref{fig:solar_gans_diagram} shows a diagram of each cGAN.


\subsection{Generator}
The generator network must be able to translate between two types of images. 
