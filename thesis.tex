...
\begin{itemize}
  ...
  \item while the seismic maps are always generated for the solar farside, the
        ...
        further complicated by the fact that between August 2014 and January
        2016 
        % https://stereo-ssc.nascom.nasa.gov/solar_conjunction.shtml
        
        the do not face the same
        direction due to the orbit of STEREO, i.e. STEREO's position changes
        relative to earth, as can be seen in figure:
...
\begin{figure}[h]
  \centering
  \includegraphics{STEREO_pos.png}
  ...
  is at the origin with the Earth fixed on X axis. \textit{Image generated using
