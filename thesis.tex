...
\begin{itemize}
  ...
  dopplergrams which measure the line-of-sight motion of the solar surface. As
  detailed in Section \ref{sec:FHSM}, these dopplergrams can be used to generate
  farside seismic maps. However, by nature of orbiting the Earth, SDO is unable
  ...
  ultraviolet imager onboard images the Sun at a wavelength of
  \SI{304}{\angstrom}. 
...
\begin{figure}
  ...
  \caption[Project Pipeline]{Summary of the project. A cGAN is trained on SDO
    data to be able to generate EUV images. This is applied to STEREO-A EUV images
...
coverage of the solar magnetic field. However, with STEREO-A no longer giving a
