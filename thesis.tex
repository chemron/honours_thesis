...
and true magnetograms and compare these values. 

This metric is typically used for predicting solar flares in individual active
regions for example
\citet{song_statistical_2009,yuan_solar_2010,lan_automated_2012,chen_identifying_2019}.
To calculate this flux, we must first determine the surface area subtended by
each pixel.\\
...
\begin{itemize}
  \item does not show small time scale variations seen in SDO
...
\begin{figure}
  ...
  \caption{The total unsigned magnetic flux according to SDO (blue), the UV GAN
