...
\end{align}
for a `fake' magnetogram input where $\mathbf{c}$ is the
"conditional" input, $D(\dotsb|\mathbf{c})$ is the discriminator output with a real
...
elements is taken. The total discriminator cost function is then
\begin{align}
