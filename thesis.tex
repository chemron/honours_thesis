...
%TODO: rewrite! this is just getting it down quickly
A complex and self-regenerating dynamo produces a continuously changing solar
magnetic field beneath the Sun's surface. Flux ropes produced by this field may
% what are flux ropes
rise and penetrate through the solar surface, forming an active region. These
active regions can have magnetic fields exceeding 1000 Gauss. The extreme
conditions in active regions can create a build up of magnetic energy. If the
active region is unable to dissapate this energy, this can lead to an energetic
magnetic reconnection event causing an explosive release of built up energy.
Such erruptions can cause solar flares or coronal mass ejections and pose a
danger to earth.\\
...
The STEREO mission consits of two space craft which observe the Sun on a
heliocentric orbit. these spacecraft rotate about the Sun relative to Earth and
observe the farside at some points in their mission.  \citet{Kim2019} were able to
...
helioseismic holography. This is a helioseismic technique
