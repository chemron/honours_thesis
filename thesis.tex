...
synthetic magnetograms based on EUV data. As the synthetic `UV' magnetograms
...
capture the instrument degradation\textemdash and could be used to adjust for it. Making
...
a cGAN to generate magnetograms from seismic data based on the nearside magnetograms
